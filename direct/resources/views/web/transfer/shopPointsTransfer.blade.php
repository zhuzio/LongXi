...
@section('content')
    ...
    <div class="cpContainer">
        <p>购物积分转账</p>
        <div class="cpList"><span class="cpTitle">总购物积分</span><i>{{ $data->assets->shop_points }}</i></div>
        ...
        <button class="cpBtn" onclick="cpBtn()">确认转账</button>
    </div>
    <script>
                        ...
                        ,yes: function(index){
                            ...
                            * */
                            $.ajax({
                                ...
                                type:"post",
                                dataType:"json",
                                data:{to:_z_Count,money:_cNum,password:payment,cpt:cpt},
                                success:function (e) {
                                    layer.msg(e.msg);
                                },
                                error:function (e) {
